...
const botaoCadastrar = document.getElementById('botaoCadastrar') //pega o id 'botaoCadastrar' no HTML e adiciona na const "botaoCadastrar" //VOCE ESTAVA PEGANDO O ID 'botaoCadastrar' do botão AQUI, precisa ser do DO FORMULARIO, coloquei abaixo
const cadastrarProduto = document.getElementById('cadastrarProduto') //pega o formulario id "cadastrarProduto" ADICIONADO PELA PROFESSORA
...
cadastrarProduto.addEventListener('submit', (evento) => { //adiciona um evento 'click' na const "botaoCadastrar"
    ...
    console.log(produtos1) //ADICIONADO PELA PROFESSORA

    atualizarCardapio(produtos1) //chama a função "atualizarCardapio"
    modal.open = false
})
